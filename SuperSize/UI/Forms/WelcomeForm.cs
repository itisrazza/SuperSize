...
namespace SuperSize.UI.Forms
{
    public partial class WelcomeForm : Form
    {
        ...
        {
            { (Properties.Resources.Welcome, "Kia ora. Welcome to SuperSize. Let’s get you up to speed.") },
            ...
            { (Properties.Resources.Get_More_Plugins, "You can add custom logic to SuperSize. Check out the official Python plugin and development kit from the SuperSize tray menu.") },
